...
void Manager::style_tab()
{
    ...
    launcher_layout->addWidget(refresh_pix_lb, 3, 0);
    launcher_layout->addWidget(run_pix_lb, 4, 0);
    launcher_layout->addWidget(show_pix_lb, 5, 0);
    launcher_layout->addWidget(manager_pix_lb, 6, 0);
    launcher_layout->addWidget(utility_pix_lb, 7, 0);
    launcher_layout->addWidget(office_pix_lb, 8, 0);
    launcher_layout->addWidget(internet_pix_lb, 9, 0);
    launcher_layout->addWidget(graphic_pix_lb, 10, 0);
    launcher_layout->addWidget(development_pix_lb, 11, 0);
    launcher_layout->addWidget(system_pix_lb, 12, 0);
    launcher_layout->addWidget(audio_pix_lb, 13, 0);
    launcher_layout->addWidget(video_pix_lb, 14, 0);
    ...
    launcher_layout->addWidget(refresh_pix, 3, 1);
    launcher_layout->addWidget(run_pix, 4, 1);
    launcher_layout->addWidget(show_pix, 5, 1);
    launcher_layout->addWidget(manager_pix, 6, 1);
    launcher_layout->addWidget(utility_pix, 7, 1);
    launcher_layout->addWidget(office_pix, 8, 1);
    launcher_layout->addWidget(internet_pix, 9, 1);
    launcher_layout->addWidget(graphic_pix, 10, 1);
    launcher_layout->addWidget(development_pix, 11, 1);
    launcher_layout->addWidget(system_pix, 12, 1);
    launcher_layout->addWidget(audio_pix, 13, 1);
    launcher_layout->addWidget(video_pix, 14, 1);
    ...
    launcher_layout->addWidget(refresh_pix_but, 3, 2);
    launcher_layout->addWidget(run_pix_but, 4, 2);
    launcher_layout->addWidget(show_pix_but, 5, 2);
    launcher_layout->addWidget(manager_pix_but, 6, 2);
    launcher_layout->addWidget(utility_pix_but, 7, 2);
    launcher_layout->addWidget(office_pix_but, 8, 2);
    launcher_layout->addWidget(internet_pix_but, 9, 2);
    launcher_layout->addWidget(graphic_pix_but, 10, 2);
    launcher_layout->addWidget(development_pix_but, 11, 2);
    launcher_layout->addWidget(system_pix_but, 12, 2);
    launcher_layout->addWidget(audio_pix_but, 13, 2);
    launcher_layout->addWidget(video_pix_but, 14, 2);
    ///////// OTHER /////////
