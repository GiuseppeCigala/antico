...
Manager::~Manager()
{
    ...
    delete dockbar_height_spinBox;
    delete dockbar_width_spinBox;
    delete dockbar_position_comboBox;
    delete dockbar_pix;
    delete deskfolder_pix;
    delete deskdev_disk_pix;
    delete deskdev_cdrom_pix;
    delete trash_pix;
    delete dockicon_pix;
    delete sysicon_pix;
    delete desktop_pix;
    ...
    delete network_pix;
    delete graphics_pix;
    delete development_pix;
    delete system_pix;
    delete audiovideo_pix;
    delete ok_button_pix;
    delete close_button_pix;
    delete add_button_pix;
    delete remove_button_pix;
    delete restore_button_pix;
    delete question_pix;
    delete information_pix;
    delete warning_pix;
    delete critical_pix;
    ...
    delete header_col_lab;
    delete dockicon_col_lab;
    delete deskfolder_col_lab;
    delete deskfile_col_lab;
    delete deskdev_col_lab;
    delete trash_col_lab;
    delete deskapp_col_lab;
    delete date_col_lab;
    delete clock_col_lab;
    delete style_sel_tx;
    delete tree_view;
    delete app_tree;
    delete run_table;
    ...
    delete run_layout;
    delete style_layout;
    delete ok_quit_layout;
    delete rem_quit_layout;
    delete dockbar_layout;
    delete deskset_layout;
    delete sections_widget;
    delete params_widget;
    delete frame_box;
    delete dockbar_box;
    delete dockicon_box;
    delete deskfolder_box;
    delete deskfile_box;
    delete deskapp_box;
    delete deskdev_box;
    delete trash_box;
    delete sysicon_box;
    delete dateclock_box;
    delete desktop_box;
    delete launcher_box;
    delete category_box;
    delete message_box;
    delete other_box;
    delete dockbar_widget;
    delete deskset_widget;
    delete style_grid;
    delete frame_grid;
    delete dockbar_grid;
